...
flowchart TB
  ...
  Tcp[Communication.Network.TCP]
  Iocp[Communication.Network.TCP_IOCP]
  Rudp[Communication.Network.RUDP]
...
| Message channel | 메시지 단위 I/O | `IMessageChannel` (RUDP) |
...
4. **스택당 1 패키지** — TCP, RUDP, TCP_IOCP. Connector·Listener·Session을 각 NuGet에 둔다.
...
결정 근거: [[0001-transport-channel-abstraction]], [[0002-tcp-backend-selection]], [[0003-connection-lifecycle-options]], [[0004-send-options-and-handler-api]], [[0005-rudp-litenetlib-interim]]
