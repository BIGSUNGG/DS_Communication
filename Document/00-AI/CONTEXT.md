...
| 패키지 | 설명 |
| -------- | ------ |
| `Communication.Shared` | Session·Channel·Framing·Pipeline·`SendOptions`·`DisconnectReason` (2.3.1 배포) |
| `Communication.Network.TCP.Shared` | TcpSession·StreamByteChannel·TcpTransportOptions (2.3.1 배포) |
| `Communication.Network.TCP.Server` | TcpListener 수락 루프 (2.3.1 배포) |
| `Communication.Network.TCP.Client` | TcpConnector 연결 (2.3.1 배포) |
